...
const Home = () => {
  ...
  useEffect(() => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=3143d07f685efcea51898fb8cbab647a0b15523b&country=IN&year=${year}`
    )
      .then(res => {
  ...
  const handlePreviousHoliday = pyear => {
    setYear(pyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=3143d07f685efcea51898fb8cbab647a0b15523b&country=IN&year=${pyear}`
    )
      .then(res => {
        res.json().then(result => {
          setMyHoliday(result.response.holidays);
  ...
  const handleNextHoliday = nyear => {
    setYear(nyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=3143d07f685efcea51898fb8cbab647a0b15523b&country=IN&year=${nyear}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
  ...
  const handleHolidayDetail = (day, month, year) => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=3143d07f685efcea51898fb8cbab647a0b15523b&country=IN&year=${year}&day=${day}&month=${month}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
